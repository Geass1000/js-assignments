...
function logger(func, logFunc) {
    return function () {
        ...
        var js = JSON.stringify(args);

        logFunc(func.name + "(" + js.slice(1, js.length - 1) + ") starts");
        var tmp = func(...args);
        //var tmp = func.apply(this, args);
        logFunc(func.name + "(" + js.slice(1, js.length - 1) + ") ends");
